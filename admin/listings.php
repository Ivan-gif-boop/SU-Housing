...
$listingsStmt = $db->query(
    'SELECT hostelId, hostelName, physicalAddress,
            description, priceMin, priceMax, roomType,
            roomsAvailable, amenities, landlordContact,
    ...
    <div class="card">
      <div class="card-header">
        ...
        <div style="display:flex; gap:10px; align-items:center;">
          ...
          <input type="text" id="listingSearch" class="form-control"
    ...
    <div class="modal" style="max-width:640px;">
      ...
      <div class="modal-body">
        <form id="listingForm" novalidate>
          ...
          <div class="form-row">
            <div class="form-group">
              <label for="lEnvironmentType">Environment Type</label>
          ...
          <div class="form-group">
            <label for="lLandlordContact">Phone / Contact Details</label>
