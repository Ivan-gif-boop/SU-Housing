...
$listingsStmt = $db->query(
    'SELECT hostelId, hostelName, physicalAddress,
            ...
            roomsAvailable, amenities, landlordName,
            landlordContact, isActive
              ...
              <tr class="listing-row"
                ...
                <td>
                  ...
                  <div style="font-size:12px; color:var(--gray-400); margin-top:2px;">
                    <?php echo htmlspecialchars($l['physicalAddress']); ?>
                  </div>
                </td>
      ...
      <div class="modal-body">
        <form id="listingForm" novalidate>
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              <label for="lPhysicalAddress">Physical Address</label>
              <select id="lPhysicalAddress" name="physicalAddress"
                      class="form-control" required>
                <option value="">Select…</option>
                <option value="Ole Shapara Avenue, Madaraka, Nairobi">Ole Shapara Avenue, Madaraka, Nairobi</option>
                <option value="Kenyatta Avenue, Nairobi West, Nairobi">Kenyatta Avenue, Nairobi West, Nairobi</option>
                <option value="Lang'ata">Lang'ata</option>
              </select>
              <div class="form-error" id="err-lPhysicalAddress"></div>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" id="lAddress" name="physicalAddress"
                   class="form-control"
                   placeholder="e.g. Ole Shapara Avenue, Madaraka, Nairobi"
                   required/>
            <div class="form-hint">Used for geocoding the map location.</div>
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              <label for="lLandlordContact">Phone</label>
